// Database mock object for course data
const coursesDB = {
    courseCodes: {
    ...
    getCourseByCode: function (code) {
        return this.courseCodes[code] || "Course not found";
    },
    ...
    getCoursesForDepartment: function (deptCode) {
        const result = {};
        Object.keys(this.courseCodes).forEach(code => {
            if (code.includes(deptCode)) {
                result[code] = this.courseCodes[code];
            }
        });
        return result;
    }
